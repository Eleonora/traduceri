...
Doi directori technici fără experienţă în industria alimentare şi fără
un buget de marketing au lansează un produs numit Bacon Salt.

În continuare, ei caută oameni de pe siteurile de reţele sociale care
le place beconul, apoi îi adaugă ca prieteni. Un mic procent din
aceste persoane, entuziamați, începe să răspândească buzz despre Bacon
Salt. Ceea ce a început ca un trib, repede se multiplica în 37000 de
fani pe Facebook şi MySpace.

Luni mai târziu, buzzul s-a împrăștiat în articole de ziar, interviuri
TV și Sfântul Graal de PR, un aspect pe Oprah. Doi tipi care n-au
ştiut nimic despre sectorul alimentar şi nu au avut nici bugetul de
marketing, acum au un cult-hit constatabil. Inspirați, ei creează
alte cîteva produse din becon. Este naşterea unui brand.

Succesul lor a început cu un mic - foarte mic - grup de fani
auto-identificați dintr-o categorie. Chiar dacă reţelele sociale au
milioane de membri, ele niciodată nu se vor traduce în milioane de
împrăştietori de buzz. Povestea Bacon Salt ilustrează faptul că, de
obicei, un mic procent din trib în cadrul tribului mai mare care au
răspândit știrea - de obicei, aproximativ 1 la sută. Ele sunt
Un Procentari.

Un Procentari nu sunt de obicei suspecţi din bloggeri tech nume-brand,
bloggeri mămici sau bloggers de afaceri. Un Procentari sunt de multe
ori ascunse în fisuri de nişe, dar acestea sunt rădăcinile cuvântului
din gură.

În acest an, munca ta este de a-i găsi şi de a-i atrage.

_De Jackie Huba şi Ben McConnell_
